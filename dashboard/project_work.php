   ...
   <body>
      ...
      <div class="main">
         ...
         <div class="container">
            ...
            ?>
            <div class="row">
               <div class="col-md-4 text-center"><a href="language.php" class="btn btn-success px-4">Back</a>
               </div>
               <div class="col-md-4 text-center"><button class="btn btn-warning" onclick="show()">Add Project</button></div>
               <div class="col-md-4 text-center"><a href="link.php" class="btn btn-success px-4">Next</a></div>
            </div>
