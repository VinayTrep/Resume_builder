              ...
              New Business <br>Opportunities. "</i>
                ...
                INFO</span></i>
                    ...
                    <div class="skills mt-md-3">
                        ...
                        <br>
                        <u><h6 class="text-white ml-4 p-2 ">Google Analystics</h6></u>
                        <i class="far fa-horizontal-rule" style="user-select: auto;"></i>
                        <u><h6 class="text-white ml-4 p-2 ">Public Communication</h6></u>
                        <i class="far fa-horizontal-rule" style="user-select: auto;"></i>
                        <u><h6 class="text-white ml-4 p-2 ">Email Marketing </h6></u>
                        <i class="far fa-horizontal-rule" style="user-select: auto;"></i>
                        <u><h6 class="text-white ml-4 p-2 ">Sales Marketing</h6></u>
                        <i class="far fa-horizontal-rule" style="user-select: auto;"></i>
                    </div>
                    <div class="language">
                        <i class="fas fa-edit ml-3"><span class="text-white ml-md-5 font-weighter-lighter fontmb-3">LANGUAGES</span></i>
                        <u><h6 class="text-white ml-3 mt-2">ENGLISH</h6></u>
                        <i class="far fa-horizontal-rule" style="user-select: auto;"></i>
                        <u><h6 class="text-white ml-3">KANNADA</h6></u>
                        <i class="far fa-horizontal-rule" style="user-select: auto;"></i>
                    </div>
                    <div class="hobby ">
